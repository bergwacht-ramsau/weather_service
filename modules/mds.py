...
class MDS:
    ...
    def __init__(self, username, password):
        ...
        self.stations = {}
        loadStations(self)
        self.rt = RepeatedTimer(300, loadStations, self)
    ...
    def getNearestStation(self, latitude, longitude):
        ...
        return min(self.stations.items(), key=lambda x: haversine(point, (x[1]["latitude"], x[1]["longitude"])))

    def deinit(self):
        print("Stopping mds service")
        self.rt.stop()
